...
public class IMAGE_OPERATIONS {
	...
	public static final BinaryOperation<Color> ADD_COLOR = (a, b) -> (a.mix(b));
	public static final BinaryOperation<LambdaImage> ADD = (a, b) -> (xy -> ADD_COLOR.apply(a.value(xy), b.value(xy)));
